...
function init_gear_sets()
    ...
    sets.precast.JA['Repair'] = {feet="Foire Babouches",ammo="Automat. Oil +3"}
    ...
    sets.precast.WS = {
        head="Whirlpool Mask",neck="Asperity Necklace",ear1="Brutal Earring",ear2="Steelflash Earring",
        body="Manibozho Jerkin",hands="Otronif Gloves",ring1="Epona's Ring",ring2="Rajas Ring",
    ...
    sets.idle.Pet.Engaged = {
        head="Rao kabuto +1",neck="Empath Necklace",ear1="Handler's Earring",ear2="Handler's Earring +1",
        body="Rao togi +1",hands="Rao kote +1",ring1="Varar Ring +1",ring2="Varar Ring +1",
        back="Visucius's Mantle",waist="Isa Belt",legs="Rao haidate +1",feet="Rao sune-ate +1"}
    ...
    --sets.engaged = {
    --    head="Tali'ah Turban +2",neck="Asperity Necklace",ear1="Mache Earring +1",ear2="Mache Earring +1",
    --    body="Tali'ah Manteel +2",hands="Karagoz Guanti +1",ring1="Petrov Ring",ring2="Rajas Ring",
    --    back="Aptitude Mantle",waist="Hurch'lan Sash",legs="Karagoz pantaloni +1",feet="Tali'ah crackows +1"}
